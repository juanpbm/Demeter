...
class ArmJointAnglesActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ArmJointAnglesFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArmJointAnglesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArmJointAnglesActionFeedback(null);
    ...
    data.feedback = ArmJointAnglesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArmJointAnglesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ArmJointAnglesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ArmJointAnglesFeedback()
    }
...
module.exports = ArmJointAnglesActionFeedback;
