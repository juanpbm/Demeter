...
class Arm_KinovaPoseActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new Arm_KinovaPoseGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Arm_KinovaPoseGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Arm_KinovaPoseActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = Arm_KinovaPoseGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Arm_KinovaPoseActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = Arm_KinovaPoseGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new Arm_KinovaPoseGoal()
    }
...
module.exports = Arm_KinovaPoseActionGoal;
