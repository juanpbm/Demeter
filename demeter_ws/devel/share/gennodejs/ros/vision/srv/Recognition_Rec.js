...
class Recognition_RecRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Recognition_RecRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Recognition_RecRequest
    let len;
    let data = new Recognition_RecRequest(null);
  ...
  static datatype() {
    ...
    return 'vision/Recognition_RecRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Recognition_RecRequest(null);
...
class Recognition_RecResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Recognition_RecResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Recognition_RecResponse
    let len;
    let data = new Recognition_RecResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Recognition_RecResponse(null);
...
module.exports = {
  Request: Recognition_RecRequest,
  Response: Recognition_RecResponse,
  md5sum() { return '524aec0a2d224648b866e7ced15102d4'; },
  datatype() { return 'vision/Recognition_Rec'; }
};
