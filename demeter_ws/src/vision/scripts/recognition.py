...
class Recognition:
 ...
 #       self.model = VGG16(weights="imagenet")
        ...
        self.stop_srv = rospy.ServiceProxy('stop', v.Action)
        self.reposition_srv = rospy.ServiceProxy('reposition', v.Reposition)
        self.harvest_srv = rospy.ServiceProxy('harvest',v.Reposition)
